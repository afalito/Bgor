...
(function () {
  ...
  function showAlreadyPlayed(resultIds) {
    ...
    banner.style.cssText =
      "background:#F0F0F0;border:1px solid #E4E4E4;border-radius:12px;padding:14px 20px;text-align:center;margin-bottom:24px;font-size:14px;color:#666;font-weight:600;";
    banner.innerHTML =
      "Ya participaste en la ruleta &mdash; aqu&iacute; est&aacute;n tus premios guardados.";
  ...
  function revealPrizesSequence(resultIds, onComplete) {
    ...
    const LEVELS = [
      {
        key: "L1",
        level: 1,
        eyebrow: "Tu regalo · Nivel 1",
        sub: "Por compras desde $149.900",
        theme: "l1",
        btnText: "Ver siguiente premio",
        btnDelay: 750,
      },
      {
        key: "L2",
        level: 2,
        eyebrow: "Premio Nivel 2",
        sub: "Por compras desde $249.900",
        theme: "l2",
        btnText: "Ver siguiente premio",
        btnDelay: 750,
      },
      {
        key: "L3",
        level: 3,
        eyebrow: "★ TU MEJOR PREMIO ★",
        sub: "Por compras desde $374.000",
        theme: "l3",
        btnText: "¡Ver mis premios!",
        btnDelay: 3800,
      },
    ];
    ...
    function showNext() {
      ...
      const visualHTML = item.img
        ? '<div class="rv-img-wrap"><img src="' +
          item.img +
          '" alt="' +
          item.name +
          '" class="rv-img"></div>'
        : '<div class="rv-img-wrap rv-img-wrap--svg"><div class="rv-svg">' +
          getSVG(item.svg, item.name) +
          "</div></div>";
      ...
      cardEl.innerHTML =
        '<div class="rv-card rv-card--' +
        lvl.theme +
        '">' +
        dotsHTML +
        '<div class="rv-eyebrow-wrap">' +
        '<span class="rv-eyebrow">' +
        lvl.eyebrow +
        "</span>" +
        '<span class="rv-eyebrow-sub">' +
        lvl.sub +
        "</span>" +
        "</div>" +
        '<div class="rv-visual">' +
        ...
        "</div>" +
        bonosHTML +
        '<button class="rv-next-btn" id="rv-next-btn">' +
        lvl.btnText +
        "</button>" +
        "</div>";
